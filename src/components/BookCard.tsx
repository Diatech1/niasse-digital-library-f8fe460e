...
const BookCard = ({ book, index }: BookCardProps) => {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-sm aspect-[2/3] mb-3 shadow-[4px_4px_10px_rgba(0,0,0,0.3),_1px_1px_3px_rgba(0,0,0,0.2)] border-l-[3px] border-l-black/10">
        <img
          src={book.cover}
          alt={book.title}
