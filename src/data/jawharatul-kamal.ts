export const jawharatulKamalMeta = {
  title: "La Djaouharatou-l-Kamel",
  subtitle: "La Perle de la Perfection dans l'éloge du seigneur des hommes",
...
– Celui qui la récite de sept fois à plus, alors l'esprit béni du Prophète et des quatre Khalifes viennent en sa présence tant qu'il l'évoque.

– Celui qui la récite régulièrement plus de sept fois alors le Prophète l'aimera d'un amour particulier et il ne mourra qu'en étant un wali.

– Celui qui la récite sept fois avant de dormir, dans une pureté complète, sur un lit propre, celui-ci verra le Prophète.`
  },
  {
    id: "jawh-2",
    chapter: "La Perle de la Perfection",
    heading: "Texte de la prière",
    content: `« Ô mon Dieu, répands tes grâces et accorde le salut à la source de la Miséricorde Divine et au diamant étincelant versé indéfiniment dans la vérité. Celui qui est au centre de toutes formes de compréhensions et de significations.

Il est la lumière des êtres en cours de formation humaine, il possède la Vérité Divine tel l'éclair immense traversant les nuages précurseurs de la pluie bienfaisante des Miséricordes Divines, qui emplissent sur leur chemin aussi bien les grandes étendues d'eau que les petites.

Il est Ta lumière brillante qui s'étend sur toute l'existence et l'englobe dans tous ses lieux.
...
Que Dieu répande ses grâces sur lui et sur sa famille, grâces par lesquelles, Ô mon Dieu, Tu nous le feras connaître. »`
  },
  {
    id: "jawh-3",
    chapter: "Explication",
    heading: "Explication de la perle",
    content: `(1) – La source de la Miséricorde Divine ('aïni rahmati rabbaniyati) : Si on prend l'exemple d'une source d'irrigation dans laquelle se déverse le flux Divin, tous ceux à qui Allah a décrété le breuvage, s'abreuvent de ce flux. « Je ne suis qu'un répartiteur et le véritable donateur est Allah » ; « Certainement nous t'avons envoyé comme miséricorde pour les mondes » (sourate 21, verset 107).

(2) – Le diamant étincelant versé indéfiniment dans la Vérité (al yaqoutati-l-moutahaqiqati) : Le Prophète est un serviteur créé qu'Allah a honoré et ennobli par des dons immenses. Il détient la science des premiers et des derniers par l'enseignement d'Allah.

(3) – L'éclair immense traversant les nuages précurseurs de la pluie bienfaisante : les nuages remplis de profits, accordant à chaque degré ce qu'il mérite en tant que dons.

(4) – Les grandes étendues d'eau symbolisent les cœurs des grands Connaissants de Dieu. Les petites étendues d'eau symbolisent les saints.

(5) – Il est ta lumière brillante qui s'étend sur toute l'existence : Le Prophète transcende de loin tous les degrés de toutes les créatures.

(6) – Source de la Vérité : Dieu ne déverse dans cette source que la Vérité pure de laquelle se ramifient les véracités.

(7) – Origine des connaissances les plus justes : La source de la rectitude la plus parfaite.

(8) – Ton sentier parfaitement droit : ton chemin parfaitement juste et dépourvu de toutes déviances.

(9) – La manifestation de la Vérité : Celui que Dieu a embelli par les qualités de la perfection.

(10) – Le trésor le plus sublime : L'essence des secrets particuliers.

(11) – Le flux venant de Toi et retournant à Toi : Le Prophète est créé pur de toute imperfection, ses agissements sont exclusivement en vue de son Seigneur.

(12) – La quintessence des lumières dissimulées à toute connaissance : Celui dont la station n'est connue que de Dieu seul. Al Moutalsam veut dire le caché, celui qui est arrivé à un degré très élevé et inaccessible.`
  },
  {
    id: "jawh-4",
    chapter: "Phonétique",
...
« La prééminence du Coran sur toutes autres paroles d'évocations et formules de prière sur le Prophète est plus éclatante que le soleil. Il est fait cas de cet éclat dans les principes même de la Chari'a. »
