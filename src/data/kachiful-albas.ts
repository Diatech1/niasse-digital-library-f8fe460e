...
const SECTION_MARKERS = [
  { line: "AVANT PROPOS", part: "Introduction", chapter: "Avant-propos", heading: "Avant-propos" },
  { line: "INTRODUCTION", part: "Introduction", chapter: "Introduction", heading: "L'éducation spirituelle (Tarbiya)" },
  ...
  { line: "LA REUNION POUR LE ZIKR", part: "Première Partie", chapter: "Chapitre III — La récitation du Coran", heading: "La réunion pour le Zikr et la récitation du Coran" },
  { line: "DEUXIEME PARTIE", part: "Deuxième Partie", chapter: "Deuxième Partie", heading: "Deuxième Partie" },
  { line: "LA FAYDA TIJANIYA", part: "Deuxième Partie", chapter: "Chapitre I — La Fayda Tijâniya", heading: "La Fayda Tijâniya" },
  { line: "LES CONNAISSANCES EXPERIMENTALES", part: "Deuxième Partie", chapter: "Chapitre II — Les connaissances expérimentales", heading: "Les connaissances expérimentales" },
  ...
  { line: "MISE EN GARDE CONTRE LA CONTRADICTION", part: "Troisième Partie", chapter: "Chapitre I — Mise en garde", heading: "Mise en garde contre la contradiction des élus de Dieu" },
  { line: "LA NECESSITE DE RECHERCHER UN GUIDE", part: "Troisième Partie", chapter: "Chapitre II — Le guide spirituel", heading: "La nécessité de rechercher un guide droit" },
  { line: "LA VERACITE DE LA VISION", part: "Troisième Partie", chapter: "Chapitre III — La vision divine", heading: "La véracité de la vision des hommes de Dieu" },
