...
export const books: Book[] = [
  ...
  },
  {
    ...
    description: "Le Wird Tidjane — Les 23 conditions de la voie, le Lazim (Al-Fatiha, Istighfar, Salatul-Fatihi, Tahlil), la Wazifa (Jawharatul-Kamal), le Dhikr du vendredi (Zikru Juma), les devoirs collectifs et les règles de réparation (Niya Jabr). Un guide complet pour la pratique quotidienne de la Tariqa Tijaniyya.",
    hasAudio: false,
