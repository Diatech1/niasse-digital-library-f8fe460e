...
export const ifadatExtrait2Sections: ArticleSection[] = [
  {
    id: "ifadat2-1",
    chapter: "Ifadatou-l-Ahmediyya – Extrait 2",
    heading: "Parole 2 : L'amour et la haine envers le Cheikh",
    content: `Seïdina Ahmed Tidjani (qu'Allah sanctifie son précieux secret) a dit :

« Je leur dis comme il a été dit au sujet de 'Ali ibn Abi Taleb (qu'Allah l'agrée), qu'il départage le feu. Celui qui nous aime il lui sera dit : "Entre au Paradis" et celui qui nous déteste et meurt sur cela il lui sera dit : "Entre dans le feu". »
...
Selon Zar ibn Habiche qui a dit : « J'ai entendu 'Ali dire : "Par celui qui a créé le grain et souffle le vent, le Prophète (que la prière et la paix d'Allah soient sur lui) m'a promis que ne peut m'aimer qu'un croyant et ne peut me détester qu'un hypocrite." » (Rapporté par Mouslim, Tirmidhi, Nassa-i et Tabarani.)`,
  },
  {
    id: "ifadat2-2",
    chapter: "Ifadatou-l-Ahmediyya – Extrait 2",
    heading: "Parole 3 : La prière derrière l'Imam",
    content: `Seïdina Ahmed Tidjani (qu'Allah sanctifie son précieux secret) a dit :

« Il m'a ordonné, celui à qui je ne peux désobéir, de ne prier derrière personne hormis pour la prière du Djoumou'a. »
...
Seïdina (qu'Allah sanctifie son précieux secret) n'aimait pas passer Imam sauf lorsqu'il était au sein de sa famille, chez lui. Il avait pris comme Imam pour diriger la prière le Chérif et savant Sidi Mohamed ibn Mechri (qu'Allah l'agrée). C'est en 1208 qu'il a dû prendre la direction de la prière.
